<template>
  <div id="root" class="testtttt">
    ...
    <div class="flex items-center justify-center h-screen v-screen">
      <div class="bg-white rounded-xl flex flex-col items-center justify-center p-8">
      <h2 class="mb-4">Are you a business or an author?</h2>
      <NuxtLink to="/restaurant-register">Business Registration</NuxtLink>
      <NuxtLink to="/author-register">Author Registration</NuxtLink>
      </div>
    </div>
  </div>
</template>
